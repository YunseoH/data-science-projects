Promise.all([
  d3.json("alcohol_attributable_fraction_of_mortality.json"),
  d3.json("beer_consumption_per_person.json"),
  d3.json("wine_consumption_per_capita.json"),
  d3.json("spirits_consumption_per_person.json"),
